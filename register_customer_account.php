...
<head>
                    ...
                    <form class="login-form text-center" method="post" action="register_customer_account.php" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        <input type="text" class="form-control rounded-pill form-control-lg" placeholder="First Name"  name="c_f_name" required autocomplete="off">
                                    </div>

                                    <div class="form-group col-6">
                                        <input type="text" class="form-control rounded-pill form-control-lg" placeholder="Last Name" name="c_L_name" autocomplete="off" required>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="form-group col-6">
                                        <input type="password" id="txtNewPassword" placeholder="Enter password" name="c_pass"class="form-control rounded-pill form-control-lg" autocomplete="off" required>
                                    </div>

                                    <div class="form-group col-5">
                                        <input  type="password" id="txtConfirmPassword" placeholder="Confirm Password" name="c_con_pass" class="form-control rounded-pill form-control-lg" autocomplete="off" required>
                                    </div>
 ...
 <?php
    $con=mysqli_connect("localhost","root","","foodstuff");
 if(isset($_POST['c_register'])){
   ...
   if(mysqli_num_rows($duplicate)>0){
     ...
     send_sms($_POST['c_phn'],"Dear " . $_POST['c_f_name'] . ", your account for kisanmitra is created successfully :)  KEEP SHOPPING");
