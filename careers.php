                ...
                <div class="col-md-6 m-auto">
                    ...
                    <a href="" class="btn btn-primary text-light px-1 py-0"> <i class="fa fa-instagram"></i> </a>
                        ...
                        <div class="col-md-6 p-2 text-right">
                             <a href="" class=" text-light mr-3"> <i class="fa fa-phone"></i>+91 9128434558</a>
                             <a href="" class="text-light "> <i class="fa fa-envelope"></i>kisanmitra@gmail.com</a>
                    </div>
             </div>
    </div>
...
<!--
       ...
       <div class="row">
           <div class="col-md-6 m-auto section text-center">
               ...
               <p class="small text-justify text-center"><b> Kisan Mitra</b> is built around the idea that everyone should have access to fresh milk, no matter where they stay, what do they do, and how tech savvy are they. If you think you can offer the same level of convenience to our customers through what you do, please drop in or just drop down a mail to <b>hr@kisanmitra.com.</b></p>
           </div>
       </div>
