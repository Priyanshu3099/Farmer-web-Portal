           ...
           <div class="card shadow-sm mt-4">
              <div class="row">
                ...
                <div class="col-lg-3 " style="border-left:solid #ccc 1px">
                 <span style="font-size:130%;font-family: 'Josefin Sans', sans-serif;margin-left:5%;margin-top:20%">Why call? just click!</span> <br> <span style="font-size:80%;margin-left:5%">Easily Track your Kisan Mitra order</span><br><br>
          ...
          <div class="card shadow-sm mt-4 text-capitalize" style="font-family: 'Josefin Sans', sans-serif;">
              <div class="row mt-4 ml-3">
                ...
                <div class="col-lg-4" style="border-left: solid 1px #ccc">
                  ...
                  <p style="color:#556"><i class="fab fa-get-pocket text-info" ></i>   Get in touch with us: <br> <a href="#" style="color:#556; margin-left:5%">kisanmitra@gmail.com</a> </p>
