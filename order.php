    ...
    $con=mysqli_connect("localhost","root","","foodstuff");
             ...
             <div class="card shadow-sm mt-3" style="width:100%">
               ...
               <?php
                    ...
                    $con=mysqli_connect("localhost","root","","foodstuff");
                   $query=mysqli_query($con,"SELECT * FROM product inner join vendor on product.v_email=vendor.v_email WHERE p_id='$p_id'");
...
//$sql="INSERT INTO custm(cid,pwd,uname,addr,phone,email,gender,acno,ifsc,country)VALUES('$cid','$pwd','$uname','$addr','$phone','$email','$gender','$acno','$ifsc','$country')";
                     ...
                     $insert = mysqli_query($con,"INSERT INTO orders (invoice_no,c_id,p_id,v_email,qty) values ('$id','$c_id','$p_id','$v_email','$qty')");
                      ...
                      $res=mysqli_query($con,"SELECT c_phn FROM customer where cid='$c_id'"); 
                       
                       while($row= mysqli_fetch_array($res))
{

//$remain_rice=$row['remain_rice'];
$c_phn=$row['c_phn'];
                       }
                       
                       if(isset($_POST['order']))
{
                           $username = "kdeepak18072001@gmail.com";
//	$username = $_POST['username'];
	$hash = "0c9037641ea8abfca55738b6464cfe15c5b355ed18e83abd8491d452c2b2edd1";
	//$hash = $_POST['hash'];
	...
	$numbers =  $c_phn;// A single number or a comma-seperated list of numbers
